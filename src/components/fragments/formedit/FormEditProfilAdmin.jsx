...
export default function FormEditProfilAdmin() {
  ...
  const [profileImage, setProfileImage] = useState("src/assets/images 2/profil admin.jpg"); // Gambar profil default
  ...
  const handleSave = (e) => {
    ...
    Swal.fire({
      ...
      preConfirm: () => {
        navigate("/editprofil-admin"); // Navigasi setelah menyimpan
        return true;
      },
    });
  };
  ...
  return (
    <form className="flex flex-col items-start space-y-6">
      <div className="w-full flex flex-col items-center">
        <img src={profileImage} alt="Foto Profil Admin" className="w-32 h-32 rounded-full shadow-md" />
      ...
      <div className="w-full space-y-4">
        ...
        <div className="w-full flex items-end space-x-2 mt-2">
          ...
          <Button className="bg-[#415952] text-white h-[42px] px-4 rounded-md" onClick={() => navigate("/gantiemail-admin")}>
            Ganti Email
          </Button>
        </div>
      </div>
