...
import FormGantiEmailDokter from "@/components/fragments/formemail/FormGantiEmailDokter";
  ...
  return (
    <section className="flex flex-col min-h-screen bg-white">
      ...
      <footer className="flex justify-start p-10 bg-white shadow-md">
        <button className="bg-[#C90000] text-white py-1 px-7 rounded-[10px]" onClick={() => navigate("/editprofil-dokter")}>
          Kembali
        </button>
      </footer>
    </section>
